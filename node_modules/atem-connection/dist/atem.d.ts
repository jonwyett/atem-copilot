...
import { FairlightAudioMonitorChannel, FairlightAudioCompressorState, FairlightAudioLimiterState, FairlightAudioEqualizerBandState, FairlightAudioExpanderState, FairlightAudioRoutingSource, FairlightAudioRoutingOutput } from './state/fairlight';
...
export declare class Atem extends BasicAtem {
    ...
    uploadStill(index: number, data: Buffer, name: string, description: string, options?: DT.UploadStillEncodingOptions): Promise<void>;
    uploadClip(index: number, frames: Iterable<Buffer> | AsyncIterable<Buffer>, name: string, options?: DT.UploadStillEncodingOptions): Promise<void>;
